...
def test_to_datetime64_ms_supports_microseconds_and_nanoseconds() -> None:
    for unit, values in [
        ("us", [1_700_000_000_000_000, 1_700_000_000_010_000]),
        ("ns", [1_700_000_000_000_000_000, 1_700_000_000_010_000_000]),
    ]:
        out = to_datetime64_ms(pd.Series(values, dtype="int64"), default_unit="s")
