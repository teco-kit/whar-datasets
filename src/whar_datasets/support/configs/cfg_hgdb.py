...
def parse_hgdb(
    ...
    all_dfs = []
    base_path = r"C:\Users\hohma\Teco\whar-parsers\notebooks\archive\HumanGaitDataBase"
    ...
    changes = (
        ...
        (df["timestamp"] < df["timestamp"].shift(1)) |      # Zeit springt zurück -> Neue Datei/Session
    ...
    session_metadata = df.groupby("session_id")[metadata_cols].first().reset_index(drop=True)
